...
class FacultyAllEvent extends StatefulWidget {
  @override
  _FacultyAllEventState createState() => _FacultyAllEventState();
}

class _FacultyAllEventState extends State<FacultyAllEvent> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: SecondAppBarBuilder("All Upcoming Events"),
      body: Platform.isIOS
          ? Container()
          : RefreshIndicator(
              displacement: 40,
